...
<body>
	...
	<hr/>
	<s:form action="formTags_passwordTag" namespace="/chapter06" method="get" >
		<s:textfield name="ph.username" label="Username:" /><br/>
		<s:password name="ph.password" label="Password:" /><br/>
		<s:submit value="登录"/>
	</s:form>
</body>
</html>