...
<body>
	...
	<hr/>
	<s:form action="formTags_labelTag" namespace="/chapter06" method="get" >
		<s:date name="ph.birth" format="yyyy年MM月dd日"/>
		<s:date name="ph.birth" format="yyyy年MM月dd日" var="date"/><br/>
		<s:date name="ph.married" format="yyyy年MM月dd日" nice="true"/><br/>
